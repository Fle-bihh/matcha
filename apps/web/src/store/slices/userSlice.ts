...
export const setContainer = (containerInstance: Container) => {
			...
			.addCase(
				...
				(state, action: PayloadAction<User[]>) => {
					...
					if (!Array.isArray(action.payload)) {
						...
						state.error = "Format de données utilisateur invalide";
						return;
					}
					...
					logger.debug("Valid users after filtering:", validUsers);
