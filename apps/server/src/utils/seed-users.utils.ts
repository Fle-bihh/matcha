...
const CITIES = [
  ...
  },
  {
    ...
    latitude: 40.7128,
    longitude: -74.006,
    neighborhoods: ["Brooklyn", "Manhattan", "Queens", "Bronx", "Williamsburg"],
  },
  {
    city: "Tokyo",
    country: "Japan",
  ...
  },
  {
    ...
    latitude: 51.5074,
    longitude: -0.1278,
    neighborhoods: ["Soho", "Camden", "Shoreditch", "Notting Hill", "Chelsea"],
  },
  {
    city: "Sydney",
    country: "Australia",
    latitude: -33.8688,
    longitude: 151.2093,
    neighborhoods: ["Bondi", "Surry Hills", "Newtown", "Darlinghurst", "Manly"],
  },
  {
    city: "Berlin",
    country: "Germany",
